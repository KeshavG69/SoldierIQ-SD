...
from routers import health, upload, chat, models, auth, mindmap, report_suggestions, reports, flashcards, podcast, tak, simple_chat, google_drive, sharepoint, public_pages, workspace, invitations, organizations, document_access
...
app.include_router(document_access.router, prefix="/api")
